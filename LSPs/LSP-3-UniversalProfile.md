...
interface ILSP3  /* is ERC165 */ {
    ...
    function getData(bytes32[] calldata key) public view returns (bytes[] memory value);
    ...
    function setData(bytes32[] calldata key, bytes[] calldata value) public onlyOwner;
